    ...
    <div class="col-12">
        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
            <div class="flex-grow-1">
                <p class="text-muted mb-0">Review and manage pending MT5 User Creation.</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <span class="text-secondary float-end">Total Pending MT5 User Creation: <b><?= count($users) ?></b></span>
                <h5 class="card-title mb-0">Pending MT5 User Creation</h5>
            </div>
            <div class="card-body">
                <table id="main-dt" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= date('Y-m-d H:i:s', strtotime($row->kyc_created_at)) ?></td>
                            <td>
                                <button type="button" class="btn btn-success btn-sm" onclick="showModal(<?= $row->id ?>, '<?= $row->full_name ?>', '<?=$row->kyc_id_number?>', '<?= date('Y-m-d H:i:s', strtotime($row->kyc_created_at)) ?>')">Create MT5</button>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<!-- Modal -->
<div class="modal fade" id="sendModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="kycModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="kycModalLabel">User Detail</h5>
            ...
            <div class="modal-body text-center p-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?= form_open('admin/mt5-api/sendUser/', ['id' => 'sendForm', 'class' => 'd-inline']) ?>
