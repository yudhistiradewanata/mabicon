<?= $this->include('partials/main') ?>
    ...
    <head>
        ...
        <?php $this->load->view('partials/title-meta', array('title'=>'Companies List')); ?>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <?php $this->load->view('partials/page-title', array('pagetitle'=>'Companies', 'title'=>'Companies List')); ?>
