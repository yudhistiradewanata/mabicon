...
<head>
    ...
    <?php $this->load->view('partials/title-meta', array('title'=>'Apex Column Charts')); ?>
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <?php $this->load->view('partials/page-title', array('pagetitle'=>'Apexcharts', 'title'=>'Column Charts')); ?>
