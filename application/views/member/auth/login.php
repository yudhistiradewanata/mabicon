                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <?=form_open('member/auth/login')?>
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="<?=site_url('member/auth/forgotPassword')?>" class="text-muted">Forgot password?</a>
                                            </div>
                                        ...
                                        <div class="mt-4 text-center">
                                            ...
                                            <a class="btn btn-primary w-100" href="<?=site_url('member/auth/register')?>">Create an Account</a>
                                        </div>
                                    <?=form_close()?>
                                </div>
                            </div>
