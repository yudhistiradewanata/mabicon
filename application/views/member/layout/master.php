...
<body>
    ...
    <div id="layout-wrapper">
        <?php $this->load->view('member/layout/topbar') ?>
        <?php $this->load->view('member/layout/sidebar') ?>
        <!-- ============================================================== -->
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <?php if(isset($hidePageTitle) && $hidePageTitle){
                        ...
                        $this->load->view('member/layout/page-title', array('pagetitle'=>$title, 'title'=>$title));
                    } ?>
                    <?=showFlashData()?>
                    <?=$content?>
                </div>
